  ...
  <div class="flex-container">
    <div id="problem-main">
      ...
      <Panel :padding="40" shadow>
        <div class="report"><a title="Báo lỗi bài tập này" target="_blank" onclick="event.preventDefault();window.open('https://github.com/codehub-is/comments/issues/1', '_blank');" rel="noreferrer nofollow noopener"><i class="ivu-icon ivu-icon-md-bug"></i> {{$t('m.Report')}}</a></div>
      ...
      <!-- <Card :padding="20" dis-hover>
        ...
        <ul style="margin-left: 30px;margin-top: 20px;">
          <li><a rel="nofollow noopener noreferrer" target="_blank" class="animation-text" href="https://gist.github.com/">Quy tắc thảo luận &#38; hướng dẫn đăng bình luận ✍️</a></li>
    ...
    <div id="right-column">
      ...
      <!-- <Card style="margin-top: 20px;" :padding="10" v-if="!this.contestID || OIContestRealTimePermission">
        ...
        <span class="card-title">Ủng hộ iSPACE CodeHub</span>
        </div>
